 ...
 * @date 2021/6/21
 */
public class NewClickHouseDynamicTableSource implements ScanTableSource, LookupTableSource, SupportsLimitPushDown {
    ...
    public NewClickHouseDynamicTableSource(ResolvedSchema resolvedSchema, ClickHouseOptions options, JdbcLookupOptions lookupOptions) {
    ...
    public DynamicTableSource copy() {
        NewClickHouseDynamicTableSource tableSource = new NewClickHouseDynamicTableSource(resolvedSchema, options, lookupOptions);
        return tableSource;
    }
